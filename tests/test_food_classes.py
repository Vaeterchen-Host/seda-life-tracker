...
"""Tests for the SEDA food classes. Partly AI-generated."""
...
def zero_nutrient_summary():
    """Create a zero nutrient summary for each test. Partly AI-generated."""
    return _zero_dataclass(NutrientSummary)


@pytest.fixture
def test_food(zero_nutrient_summary):
    """Create a food object for each test. Partly AI-generated."""
    return Food(
        1,
        "Apple",
        150,
...
def test_food_amount_setter_rejects_invalid_amount(test_food):
    """This test checks if invalid food amounts are rejected. Partly AI-generated."""
    with pytest.raises(ValueError):
        test_food.amount = 0


def test_food_constructor_rejects_invalid_amount(zero_nutrient_summary):
    """This test checks if constructor amount validation works. Partly AI-generated."""
    with pytest.raises(ValueError):
        Food(
            1,
            "Apple",
...
def test_food_constructor_rejects_invalid_unit_type(zero_nutrient_summary):
    """This test checks if invalid unit types are rejected. Partly AI-generated."""
    with pytest.raises(ValueError):
        Food(
            1,
            "Apple",
...
def test_meal_calculates_calories(test_food):
    """This test checks if meal calories are calculated correctly. Partly AI-generated."""
...
def test_meal_preserves_unknown_calories(zero_nutrient_summary):
    """This test checks if unknown calories stay unknown. Partly AI-generated."""
    food = Food(
        1,
        "Apple",
        150,
...
def test_meal_uses_zero_for_unknown_calories_with_multiple_foods(zero_nutrient_summary):
    """This test checks if unknown calories count as zero in mixed meals. Partly AI-generated."""
    known_food = Food(
        1,
        "Apple",
        150,
...
def test_meal_calculates_big_seven(test_food):
    """This test checks if big seven values are calculated correctly. Partly AI-generated."""
    meal = Meal(1, "Fruit", [test_food])
...
def test_meal_preserves_unknown_big_seven_values(zero_nutrient_summary):
    """This test checks if unknown big seven values stay unknown. Partly AI-generated."""
    food = Food(
        1,
        "Apple",
        150,
...
def test_meal_uses_zero_for_unknown_big_seven_with_multiple_foods(
    ...
    """This test checks if unknown big seven values count as zero in mixed meals. Partly AI-generated."""
    known_food = Food(
        1,
        "Apple",
        150,
...
def test_meal_preserves_unknown_nutrient_summary_values(zero_nutrient_summary):
    """This test checks if unknown nutrient values stay unknown. Partly AI-generated."""
...
def test_meal_uses_zero_for_unknown_nutrients_with_multiple_foods(
    ...
    """This test checks if unknown nutrients count as zero in mixed meals. Partly AI-generated."""
